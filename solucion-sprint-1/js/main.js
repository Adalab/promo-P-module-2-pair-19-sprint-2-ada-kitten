...
const GITHUB_USER = 'graciagarpin';
const SERVER_URL = `https://adalab-api.herokuapp.com/api/kittens/${GITHUB_USER}`;
//JSON.parse --> conviértelo en un objeto para trabajr con él
//getItem --> coge del localStorage
...
if (kittenListStored) {
  ...
  fetch(SERVER_URL, {
    ...
    .then(function (response) {
      return response.json(); //transformación de formato
    })
    .then(function (data) {
      //setItem--> guardar en el local storage
      kittenDataList = data.results;
      localStorage.setItem("kittensList", JSON.stringify(kittenDataList));
     
      //vuelve a pintar el listado de gatos
